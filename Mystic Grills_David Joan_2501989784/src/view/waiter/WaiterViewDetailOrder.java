...
public class WaiterViewDetailOrder extends BaseViewDetail {
	private OrderForTableViewController orderForTableViewController;
	private MenuItemController menuItemController;
	private OrderController orderController;
	
    public WaiterViewDetailOrder() {
	...
	protected VBox content(Stage mysticGrillsApp, int orderId) {
		mysticGrillsApp.setTitle("Mystic Grills - Waiter Detail Order Page");
		...
		serveButton.setStyle("-fx-font-size: 15px; -fx-padding: 5px 15px");
		serveButton.setOnAction(e -> {
			String pesan = orderController.updateOrderStatus(orderId, "Served");
			pesanLabel.setText(pesan);
			pesanLabel.setTextFill(Color.YELLOW);
        ...
        content.getChildren().addAll(buttonBox, menuItemTableView, titleLabel, pesanLabel, menuItemIdTextField, menuItemNameTextField, menuItemPriceTextField, quantityTextField, buttonBox2, orderMenuItemTableView, totalPriceBox, buttonBox3, serveButton);
