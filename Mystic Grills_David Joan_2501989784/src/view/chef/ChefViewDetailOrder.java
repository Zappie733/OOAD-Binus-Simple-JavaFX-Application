...
public class ChefViewDetailOrder extends BaseViewDetail{
	private OrderForTableViewController orderForTableViewController;
	private MenuItemController menuItemController;
	private OrderController orderController;
	
    public ChefViewDetailOrder() {
	...
	protected VBox content(Stage mysticGrillsApp, int orderId) {
		mysticGrillsApp.setTitle("Mystic Grills - Chef Detail Order Page");
		...
		VBox.setMargin(buttonBox3, new Insets(10, 0, 20, 0));
		...
		prepareButton.setStyle("-fx-font-size: 15px; -fx-padding: 5px 15px");
		prepareButton.setOnAction(e -> {
			String pesan = orderController.updateOrderStatus(orderId, "Prepared");
			pesanLabel.setText(pesan);
			pesanLabel.setTextFill(Color.YELLOW);
        ...
        content.getChildren().addAll(buttonBox, menuItemTableView, titleLabel, pesanLabel, menuItemIdTextField, menuItemNameTextField, menuItemPriceTextField, quantityTextField, buttonBox2, orderMenuItemTableView, totalPriceBox, buttonBox3, prepareButton);
